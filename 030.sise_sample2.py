...
def MakeTable(nPageEntry, gastTable):
    ...
    stSoupDays =  BeautifulSoup(page).find(gnStrFindAll, {'class':'type2', 'width':'680'}).findAll('tr', {'onmouseover':'mouseOver(this)'})
...
#    stSelectTableText = stSoup.find(gnStrFindAll, {'class':'type2', 'width':'680'}).text;
